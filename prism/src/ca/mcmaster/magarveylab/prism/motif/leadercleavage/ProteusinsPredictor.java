...
/**
 * Predicts cleavage sites for proteusins.
 * 
 * @author Robyn Edgar, skinnider
 */
public class ProteusinsPredictor extends AbstractLeaderPredictor implements
		LeaderPredictor {
	...
	public List<Propeptide> cleaveLeader(Domain domain, Cluster cluster) {
		...
		if (motif == null) {
			System.out.println("[ProteusinsPredictor] "
					+ "No primary sactipeptide motifs identified in precursor "
	...
	public RibosomalClusterTypes type() {
		return RibosomalClusterTypes.PROTEUSIN;
	}
