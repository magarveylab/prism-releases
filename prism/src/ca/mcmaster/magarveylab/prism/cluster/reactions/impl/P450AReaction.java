...
public class P450AReaction extends GenericReaction implements Reaction {

	public P450AReaction(ReactionPlan plan, Scaffold scaffold, Cluster cluster) {
		super(plan, scaffold, cluster);
		this.domains = new DomainType[] { TailoringDomains.P450A };
	}
