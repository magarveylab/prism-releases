...
public class PhosphotransferaseReaction extends GenericReaction implements Reaction {

	public PhosphotransferaseReaction(ReactionPlan plan, Scaffold scaffold, Cluster cluster) {
		super(plan, scaffold, cluster);
		this.domains = new DomainType[] { TailoringDomains.PHOSPHOTRANSFERASE_1, 
				TailoringDomains.PHOSPHOTRANSFERASE_2 };
	}
	...
	public void execute() throws NoResidueException, TailoringSubstrateException, ScaffoldGenerationException {
		...
		if (hydroxyl == null) 
			throw new TailoringSubstrateException("Error: phosphorylation hydroxyl is null!");

		String smiles = "IP(O)(O)=O";
