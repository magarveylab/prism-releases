...
public class C1DRingCyclaseAnnotator implements Annotator {

	public DomainType[] domains() {
		return new DomainType[] { TypeIIPolyketideDomains.CYCLASE_CLADE_6b_SUBTYPE_2 };
	}
	...
	public List<SubstrateSet> findSubstrates(Domain domain, List<Module> permutation, Cluster cluster) 
		...
		if (permutation.size() < 9) {
			System.out.println("[TetracyclineFourthRingCyclaseAnnotator] Error: fewer than 9 modules detected!");
			return substrates;
		}
