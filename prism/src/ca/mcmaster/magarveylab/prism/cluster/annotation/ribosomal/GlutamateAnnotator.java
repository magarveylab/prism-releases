...
/**
 * Get potential glutamate residues for the NosB/NocB P450 gamma-hydroxylase.
 * 
 * @author skinnider
 *
 */
public class GlutamateAnnotator implements Annotator {

	public DomainType[] domains() {
		return new DomainType[] { RibosomalDomains.NosB };
	}

	public List<SubstrateSet> findSubstrates(Domain domain, List<Module> permutation, Cluster cluster)
			throws InvalidSmilesException, IOException {
		List<Module> modules = RibosomalClusterAnalyzer.getModules(ProteinogenicAminoAcids.GLUTAMATE, permutation);
