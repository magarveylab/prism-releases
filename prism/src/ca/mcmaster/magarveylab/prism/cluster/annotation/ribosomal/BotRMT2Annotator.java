...
/**
 * Get potential substrates for the bottromycin iterative valine
 * beta-C-methyltransferase BotRMT2.
 * 
 * @author skinnider
 *
 */
public class BotRMT2Annotator implements Annotator {

	public DomainType[] domains() {
		return new DomainType[] { RibosomalDomains.BotRMT2 };
	}
	...
	public List<SubstrateSet> findSubstrates(Domain domain, List<Module> permutation, Cluster cluster)
		...
		List<List<Module>> subsets = RibosomalUtil.getSubsets(modules);
