...
public class HydroxylAnnotator implements Annotator {
	...
	public List<SubstrateSet> findSubstrates(Domain domain, List<Module> permutation, Cluster cluster) 
		...
		if (cluster.contains(BetaLactamDomains.DOACS)) {
			modules.addAll(ModuleAnalyzer.modules(permutation, AdenylationSubstrates.VALINE_1));
			modules.addAll(ModuleAnalyzer.modules(permutation, AdenylationSubstrates.VALINE_2));
			modules.addAll(ModuleAnalyzer.modules(permutation, AdenylationSubstrates.VALINE_3));
		}
