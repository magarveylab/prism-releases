...
Core dependencies include HMMER (3.1) and BLAST (2.2.25+). Optional but recommended dependencies include BioPerl (1.006924) for GenBank file input and Prodigal (2.6.3) for prokaryotic open reading frame prediction.
